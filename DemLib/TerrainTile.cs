...
namespace DemLib
{
    public class TerrainTile : shape 
    {
        ...
        public bool dixing;
        public bool tietu;
        public TerrainTile(bool dixing, bool tietu)
        {
            this.dixing = dixing;
            this.tietu = tietu;
            const int xRes = 1024;
        ...
        private void LoadTexture()
        {
            ...
            using (var bitmap = new Bitmap("F:/code/DEMp/DEMp/texture.jpg"))
            {
        ...
        {
            int c = 1024 / XRes;
            using (var file = new FileStream("F:/code/DEMp/DEMp/heightField.raw", FileMode.Open))
            {
